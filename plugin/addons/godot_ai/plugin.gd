...
func _continue_enter_tree_after_update_barrier() -> void:
	...
	_dispatcher.register_lazy_handler("character", HANDLERS_DIR + "character_handler.gd", [undo, _connection])
	_dispatcher.register_lazy_handler("dialogue", HANDLERS_DIR + "dialogue_handler.gd", [undo, _connection])
	...
	_dispatcher.register_lazy("scene_diagnose", "scene", &"diagnose_scene")
	_dispatcher.register_lazy("diagnose_scene", "scene", &"diagnose_scene")
	...
	_dispatcher.register_lazy("project_apply_preset", "project", &"apply_preset")
	...
	_dispatcher.register_lazy("autoload_scaffold_game_manager", "autoload", &"scaffold_game_manager")
	...
	_dispatcher.register_lazy("input_map_scaffold_preset", "input", &"scaffold_preset")
	...
	_dispatcher.register_lazy("ui_scaffold_screen", "ui", &"scaffold_screen")
	_dispatcher.register_lazy("scaffold_screen", "ui", &"scaffold_screen")
	...
	_dispatcher.register_lazy("theme_apply_preset", "theme", &"apply_preset")
	...
	_dispatcher.register_lazy("camera_scaffold_follow_2d", "camera", &"scaffold_follow_camera_2d")
	_dispatcher.register_lazy("scaffold_follow_camera_2d", "camera", &"scaffold_follow_camera_2d")
	...
	_dispatcher.register_lazy("audio_generate_procedural_sfx", "audio", &"generate_procedural_sfx")
	_dispatcher.register_lazy("audio_scaffold_buses", "audio", &"scaffold_buses")
	_dispatcher.register_lazy("audio_scaffold_music_player", "audio", &"scaffold_music_player")
	_dispatcher.register_lazy("audio_scaffold_sound_manager", "audio", &"scaffold_sound_manager")
	...
	_dispatcher.register_lazy("environment_setup_3d", "environment", &"setup_environment_3d")
	_dispatcher.register_lazy("setup_environment_3d", "environment", &"setup_environment_3d")
	_dispatcher.register_lazy("environment_setup_2d", "environment", &"setup_environment_2d")
	_dispatcher.register_lazy("character_scaffold_2d", "character", &"scaffold_2d")
	_dispatcher.register_lazy("character_scaffold_3d", "character", &"scaffold_3d")
	_dispatcher.register_lazy("dialogue_scaffold_system", "dialogue", &"scaffold_system")
	_dispatcher.register_lazy("dialogue_create", "dialogue", &"create_dialogue")
	_dispatcher.register_lazy("save_scaffold_save_system", "save", &"scaffold_save_system")
	_dispatcher.register_lazy("save_save_slot", "save", &"save_slot")
	_dispatcher.register_lazy("save_load_slot", "save", &"load_slot")
	_dispatcher.register_lazy("save_list_slots", "save", &"list_slots")
	_dispatcher.register_lazy("save_delete_slot", "save", &"delete_slot")
	_dispatcher.register_lazy("fsm_scaffold_fsm", "fsm", &"scaffold_fsm")
	_dispatcher.register_lazy("navigation_setup_region_2d", "navigation", &"setup_region_2d")
	_dispatcher.register_lazy("navigation_attach_agent_2d", "navigation", &"attach_agent_2d")
	_dispatcher.register_lazy("navigation_bake_2d", "navigation", &"bake_2d")
	_dispatcher.register_lazy("navigation_setup_region_3d", "navigation", &"setup_region_3d")
	_dispatcher.register_lazy("navigation_attach_agent_3d", "navigation", &"attach_agent_3d")
	_dispatcher.register_lazy("navigation_bake_3d", "navigation", &"bake_3d")
